...
struct ContentView: View {
    ...
    func fetchWeather(query: String) async {
        var queryText = ""
        if (query == "") {
            queryText = "http://api.weatherapi.com/v1/forecast.json?key=4f8f3d5cf08843a1a98130953251304&q=10021&days=7&aqi=no&alerts=no"
        } else {
            queryText = "http://api.weatherapi.com/v1/forecast.json?key=4f8f3d5cf08843a1a98130953251304&q=\(query)&days=7&aqi=no&alerts=no"
        }
